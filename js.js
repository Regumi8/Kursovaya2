...
async function startChat() {
    ...
    "                  МЕЧ И ТЬМА\n" +
    "═══════════════════════════════════════════════\n\n" +
    "Давным-давно земли королевства N окутал густой\n" +
    "холодный Туман. Люди пропадали без вести, деревни\n" +
    "пустели, а по ночам из мглы доносились жуткие голоса.\n\n" +
    "В сердце этого мрака, в древней цитадели, затаился\n" +
    "он — ПОВЕЛИТЕЛЬ ТУМАНА.\n\n" +
    "Ты — странник, оказавшийся в этих землях волею судьбы.\n" +
    "Твоё путешествие начинается у таверны «Уставший странник».\n\n" +
    "Введи 'help', чтобы увидеть список команд.\n" +
    "═══════════════════════════════════════════════"

    console.log(startMessage)
    await rl.question("Нажмите Enter чтобы начать игру...")
